...
insert into accommodation (accommodation_type, average_rating, country, deadline, is_automatic, is_price_per_night, max_guests, min_guests, number, price, host_id, id, city, description, location, name, street, amenities, deleted)
